...
const PANCHANG_META: Record<string, {
  Icon: (p: { size?: number }) => JSX.Element;
  label: string; labelNp: string; desc: string; color: string; glow: string;
}> = {
    ...
    <div className="min-h-screen bg-aurora relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-10 max-w-5xl relative z-10">
        ...
        <div className="text-center mb-10 animate-fadeUp">
          ...
          {/* Sunrise / Sunset decorative row */}
          <div className="flex items-center justify-center gap-6 mb-6 text-white/30 text-xs">
            <div className="flex items-center gap-1.5">
              <IconSunrise size={16} color="#F4C430" />
              <span>Sunrise</span>
            </div>
            <div className="w-16 h-px bg-white/10" />
            <div className="flex items-center gap-1.5">
              <IconSunset size={16} color="#FF6B00" />
              <span>Sunset</span>
            </div>
          </div>
