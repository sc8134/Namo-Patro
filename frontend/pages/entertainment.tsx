...
import { CricketIcon, QuizBrainIcon, ECardIcon, IconTrendingUp, IconTrendingDown, SuccessCheckIcon } from "../components/icons";

const IPL_TEAMS = [
  { name:"Mumbai Indians",        short:"MI",   color:"from-blue-600 to-blue-900",    wins:12, losses:4,  pts:24, nrr:"+0.842", dot:"bg-blue-400" },
  { name:"Chennai Super Kings",   short:"CSK",  color:"from-yellow-500 to-yellow-800",wins:11, losses:5,  pts:22, nrr:"+0.621", dot:"bg-yellow-400" },
  { name:"Kolkata Knight Riders", short:"KKR",  color:"from-purple-600 to-purple-900",wins:10, losses:6,  pts:20, nrr:"+0.412", dot:"bg-purple-400" },
  { name:"Royal Challengers",     short:"RCB",  color:"from-red-600 to-red-900",      wins:9,  losses:7,  pts:18, nrr:"+0.215", dot:"bg-red-400" },
  { name:"Delhi Capitals",        short:"DC",   color:"from-blue-400 to-blue-700",    wins:8,  losses:8,  pts:16, nrr:"-0.102", dot:"bg-sky-300" },
  { name:"Rajasthan Royals",      short:"RR",   color:"from-pink-500 to-pink-800",    wins:7,  losses:9,  pts:14, nrr:"-0.234", dot:"bg-pink-400" },
  { name:"Sunrisers Hyderabad",   short:"SRH",  color:"from-orange-500 to-orange-800",wins:6,  losses:10, pts:12, nrr:"-0.445", dot:"bg-orange-400" },
  { name:"Punjab Kings",          short:"PBKS", color:"from-red-400 to-red-700",      wins:5,  losses:11, pts:10, nrr:"-0.612", dot:"bg-red-300" },
];
...
const ECARDS = [
  { name:"Dashain",       bg:"from-red-500/30 to-orange-500/20",   msg:"शुभ दशैंको हार्दिक शुभकामना!" },
  { name:"Tihar",         bg:"from-yellow-500/30 to-orange-500/20",msg:"तिहारको हार्दिक शुभकामना!" },
  { name:"Holi",          bg:"from-pink-500/30 to-purple-500/20",  msg:"होलीको रंगीन शुभकामना!" },
  { name:"New Year",      bg:"from-blue-500/30 to-purple-500/20",  msg:"नयाँ वर्षको हार्दिक शुभकामना!" },
  { name:"Birthday",      bg:"from-pink-500/30 to-red-500/20",     msg:"जन्मदिनको हार्दिक शुभकामना!" },
  { name:"Wedding",       bg:"from-rose-500/30 to-pink-500/20",    msg:"विवाहको हार्दिक शुभकामना!" },
  { name:"Buddha Jayanti",bg:"from-yellow-500/30 to-amber-500/20", msg:"बुद्ध जयन्तीको शुभकामना!" },
  { name:"Teej",          bg:"from-red-500/30 to-pink-500/20",     msg:"तीजको हार्दिक शुभकामना!" },
];
...
export default function Entertainment() {
  ...
  const sendCard = () => { if (!selectedCard || !recipient.trim()) return; setSent(true); };

  const TABS = [
    { id: "ipl",    Icon: CricketIcon,  label: "IPL 2025" },
    { id: "quiz",   Icon: QuizBrainIcon,label: "Nepal Quiz" },
    { id: "ecards", Icon: ECardIcon,    label: "E-Cards" },
  ] as const;
          ...
          <div className="animate-fadeUp">
            <div className="backdrop-blur-2xl bg-white/5 rounded-3xl border border-white/10 overflow-hidden">
              <div className="flex items-center gap-3 px-6 py-4 border-b border-white/10">
                <CricketIcon size={24} color="#FF6B00" />
                <div>
              ...
              {IPL_TEAMS.map((t, i) => (
                <div key={t.short}
                  className="grid grid-cols-6 items-center px-6 py-4 border-b border-white/5 hover:bg-white/5 transition-colors animate-fadeUp"
                  ...
                  <span className={`text-right text-xs font-mono flex items-center justify-end gap-0.5
                    ${t.nrr.startsWith("+") ? "text-green-400" : "text-red-400"}`}>
                    {t.nrr.startsWith("+") ? <IconTrendingUp size={11} /> : <IconTrendingDown size={11} />}
                    {t.nrr}
                  </span>
                </div>
              ))}
            ...
            {!done ? (
              <div className="backdrop-blur-2xl bg-white/5 rounded-3xl border border-white/10 p-8">
                ...
                <div className="w-full bg-white/10 rounded-full h-1.5 mb-8">
                  <div className="bg-gradient-to-r from-aurora-4 to-aurora-1 h-1.5 rounded-full transition-all duration-500"
              ...
              <div className="backdrop-blur-2xl bg-gradient-to-br from-aurora-4/20 to-orange-900/20 rounded-3xl border border-aurora-4/30 p-10 text-center animate-fadeUp">
                <div className="flex justify-center mb-4 animate-float">
                  <QuizBrainIcon size={80} color="#F4C430" />
                </div>
                ...
                <p className="text-white/50 mb-6">
                  {score === QUIZ_QUESTIONS.length ? "Perfect! तपाईं नेपाल विशेषज्ञ हुनुहुन्छ!"
                    ...
                    : score >= 5 ? "Good job! अझ सिक्नुहोस्!"
                    : "Keep learning! नेपाल बारे थप जान्नुहोस्!"}
                </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-3">
                    {ECARDS.map((c, i) => (
                      <div key={c.name} onClick={() => setSelectedCard(c)}
                        ...
                        <div className="flex justify-center mb-2 group-hover:scale-110 transition-transform duration-300">
                          <ECardIcon size={40} color={selectedCard?.name === c.name ? "#F4C430" : "#FF6B00"} />
                        </div>
                ...
                <div className="backdrop-blur-2xl bg-white/5 rounded-3xl border border-white/10 p-6">
                  ...
                  {selectedCard && (
                    <div className="flex items-center gap-3 mb-4 backdrop-blur-xl bg-white/5 rounded-2xl p-3 border border-white/10">
                      <ECardIcon size={32} color="#FF6B00" />
                      <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <textarea value={message} onChange={(e) => setMessage(e.target.value)}
                        placeholder="Add a personal message..." rows={3}
